...
import dll.IUListWithListIterator;

/**
 * Tests for Sort class using IUDoubleLinkedList as an implementation of IUListWithListIterator.
 * @author CS221
 */
public class SortTester {
	 ...
	 * @return [ ]
	 */
	private static IUListWithListIterator<Integer> newList() {	//TODO: specify the underlying list class, here
		return new IUDoubleLinkedList<Integer>();
	}
	
	/** @return [A] */
	private static IUListWithListIterator<Integer> listA() {
		Integer[] elements = {ELEMENT_A};
		return newListWithElements(elements);
	}
	
	/** @return [A,B] */
	private static IUListWithListIterator<Integer> listAB() {
		Integer[] elements = {ELEMENT_A, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [B,A] */
	private static IUListWithListIterator<Integer> listBA() {
		Integer[] elements = {ELEMENT_B, ELEMENT_A};
		return newListWithElements(elements);
	}
	
	/** @return [A,A] */
	private static IUListWithListIterator<Integer> listAA() {
		Integer[] elements = {ELEMENT_A, ELEMENT_A};
		return newListWithElements(elements);
	}

	/** @return [A,B,C] */
	private static IUListWithListIterator<Integer> listABC() {
		Integer[] elements = {ELEMENT_A, ELEMENT_B, ELEMENT_C};
		return newListWithElements(elements);
	}

	/** @return [A,C,B] */
	private static IUListWithListIterator<Integer> listACB() {
		Integer[] elements = {ELEMENT_A, ELEMENT_C, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [B,A,C] */
	private static IUListWithListIterator<Integer> listBAC() {
		Integer[] elements = {ELEMENT_B, ELEMENT_A, ELEMENT_C};
		return newListWithElements(elements);
	}
	
	/** @return [B,C,A] */
	private static IUListWithListIterator<Integer> listBCA() {
		Integer[] elements = {ELEMENT_B, ELEMENT_C, ELEMENT_A};
		return newListWithElements(elements);
	}
	
	/** @return [C,A,B] */
	private static IUListWithListIterator<Integer> listCAB() {
		Integer[] elements = {ELEMENT_C, ELEMENT_A, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [C,B,A] */
	private static IUListWithListIterator<Integer> listCBA() {
		Integer[] elements = {ELEMENT_C, ELEMENT_B, ELEMENT_A};
		return newListWithElements(elements);
	}

	/** @return [A,A,B] */
	private static IUListWithListIterator<Integer> listAAB() {
		Integer[] elements = {ELEMENT_A, ELEMENT_A, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [A,B,A] */
	private static IUListWithListIterator<Integer> listABA() {
		Integer[] elements = {ELEMENT_A, ELEMENT_B, ELEMENT_A};
		return newListWithElements(elements);
	}

	/** @return [B,A,A] */
	private static IUListWithListIterator<Integer> listBAA() {
		Integer[] elements = {ELEMENT_B, ELEMENT_A, ELEMENT_A};
		return newListWithElements(elements);
	}

	/** @return [A,B,B] */
	private static IUListWithListIterator<Integer> listABB() {
		Integer[] elements = {ELEMENT_A, ELEMENT_B, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [B,A,B] */
	private static IUListWithListIterator<Integer> listBAB() {
		Integer[] elements = {ELEMENT_B, ELEMENT_A, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [B,B,A] */
	private static IUListWithListIterator<Integer> listBBA() {
		Integer[] elements = {ELEMENT_B, ELEMENT_B, ELEMENT_A};
		return newListWithElements(elements);
	}
	
	/** @return [A,B,C,D] */
	private static IUListWithListIterator<Integer> listABCD() {
		Integer[] elements = {ELEMENT_A, ELEMENT_B, ELEMENT_C, ELEMENT_D};
		return newListWithElements(elements);
	}

	/** @return [B,D,A,C] */
	private static IUListWithListIterator<Integer> listBDAC() {
		Integer[] elements = {ELEMENT_B, ELEMENT_D, ELEMENT_A, ELEMENT_C};
		return newListWithElements(elements);
	}
	
	/** @return [C,A,D,B] */
	private static IUListWithListIterator<Integer> listCADB() {
		Integer[] elements = {ELEMENT_C, ELEMENT_A, ELEMENT_D, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [D,C,B,A] */
	private static IUListWithListIterator<Integer> listDCBA() {
		Integer[] elements = {ELEMENT_D, ELEMENT_C, ELEMENT_B, ELEMENT_A};
		return newListWithElements(elements);
	}

	/** @return [A,B,C,C] */
	private static IUListWithListIterator<Integer> listABCC() {
		Integer[] elements = {ELEMENT_A, ELEMENT_B, ELEMENT_C, ELEMENT_C};
		return newListWithElements(elements);
	}

	/** @return [C,A,C,B] */
	private static IUListWithListIterator<Integer> listCACB() {
		Integer[] elements = {ELEMENT_C, ELEMENT_A, ELEMENT_C, ELEMENT_B};
		return newListWithElements(elements);
	}

	/** @return [C,C,B,A] */
	private static IUListWithListIterator<Integer> listCCBA() {
	...
	private boolean testTimeToSortBigList() {
		...
		try {
			IUListWithListIterator<Integer> list1 = newList();
	 ...
	 */
	private static boolean testSort(IUListWithListIterator<Integer> listToSort, IUListWithListIterator<Integer> sortedList) {
		try {
	 ...
	 * @return true if listToSort and sortedList are the same after sorting listToSort
	 */
	private static boolean testSort(IUListWithListIterator<Integer> listToSort, IUListWithListIterator<Integer> sortedList, Comparator<Integer> c) {
		try {
	 ...
	 * @return the list
	 */
	private static IUListWithListIterator<Integer> newListWithElements(Integer[] elements) {
		IUListWithListIterator<Integer> list = newList();
	 ...
	 */
	private static <T> boolean equivalentLists(IUListWithListIterator<T> list1, IUListWithListIterator<T> list2) {
	 ...
	 */
	private static void printLists(IUListWithListIterator<Integer> list1, IUListWithListIterator<Integer> list2) {
